...
## PROBLEM STATEMENT:
Electricity demand is often uneven, causing overloads and power cuts in cities and there is no smart system to predict usage and balance the load efficient leading to potential failure
